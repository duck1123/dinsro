(ns dinsro.ui.forms.admin.core.peers
  (:require
  ...
  {:type   :button
   ...
   :action (fn [this _key]
             (let [{::m.c.peers/keys [addr id]
                    node             o.c.peers/node} (comp/props this)
...
(form/defsc-form NewForm
  ...
  {fo/action-buttons [::submit]
   ...
   fo/field-options  {o.c.peers/node u.pickers/node-picker}
   fo/field-styles   {o.c.peers/node :pick-one}
   fo/id             m.c.peers/id
