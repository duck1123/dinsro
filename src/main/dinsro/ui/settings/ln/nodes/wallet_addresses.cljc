...
(def index-page-key :settings-ln-nodes-show-wallet-addresses)
...
(report/defsc-report Report
  ...
  {ro/column-formatters {::m.c.wallet-addresses/wallet #(u.links/ui-wallet-link %2)}
   ...
   ro/page-size         10
   ro/paginate?         true
   ro/row-actions       [(u.buttons/subrow-action-button "Generate" ::m.c.wallet-addresses/id parent-model-key mu.c.wallet-addresses/generate!)]
...
(m.navlinks/defroute   :settings-ln-nodes-show-wallet-addresses
