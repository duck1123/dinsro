...
(def index-page-key :core-chains-show-networks)
...
(defsc SubPage
  ...
  (if report
    (ui-report report)
    (u.debug/load-error props "chain networks page")))

(m.navlinks/defroute   :core-chains-show-networks
  {::m.navlinks/control       ::SubPage
   ::m.navlinks/label         "Networks"
   ::m.navlinks/model-key     ::m.c.networks/id
   ::m.navlinks/parent-key    :core-chains-show
