...
(m.navlinks/defroute :admin-ln-accounts
  {::m.navlinks/control       ::IndexPage
   ::m.navlinks/label         "Accounts"
   ::m.navlinks/model-key     ::m.ln.accounts/id
   ::m.navlinks/parent-key    :admin-ln
   ::m.navlinks/router        :admin-ln
   ::m.navlinks/required-role :admin})

(m.navlinks/defroute :admin-ln-accounts-show
  {::m.navlinks/control       ::ShowPage
   ::m.navlinks/input-key     ::m.ln.accounts/id
   ::m.navlinks/label         "Show Account"
   ::m.navlinks/model-key     ::m.ln.accounts/id
   ::m.navlinks/parent-key    :admin-ln-accounts
   ::m.navlinks/router        :admin-ln
   ::m.navlinks/required-role :admin})
