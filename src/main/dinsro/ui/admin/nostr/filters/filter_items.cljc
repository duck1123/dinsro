(ns dinsro.ui.admin.nostr.filters.filter-items
  (:require
...
(def index-page-id :admin-nostr-filters-show-filter-items)
(def model-key o.n.filter-items/id)
(def parent-model-key o.n.filters/id)
(def parent-router-id :admin-nostr-filters-show)
...
(report/defsc-report Report
  [_this _props]
  {ro/column-formatters {o.n.filter-items/filter #(u.links/ui-admin-filter-link %2)
                         o.n.filter-items/pubkey #(when %2 (u.links/ui-admin-pubkey-link %2))}
