(ns dinsro.ui.admin.nostr.pubkeys.badge-definitions
  (:require
...
(def index-page-id :admin-nostr-pubkeys-show-badge-definitions)
...
(def fetch-button
  (u.buttons/report-action-button "Fetch" parent-model-key `mu.n.pubkeys/fetch-definitions!))
