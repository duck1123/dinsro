...
(report/defsc-report Report
  [_this _props]
  {ro/column-formatters {o.n.connections/instance    #(when %2 (u.links/ui-admin-instance-link %2))
                         o.n.connections/status      #(u.links/ui-admin-connection-link %3)
                         o.n.connections/start-time  u.controls/date-formatter
                         o.n.connections/end-time    u.controls/date-formatter
