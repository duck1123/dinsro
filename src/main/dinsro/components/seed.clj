...
(s/def ::default-rate-sources (s/coll-of ::cs.rate-sources/item))

(s/def ::name string?)
(s/def ::code string?)

(s/def ::default-currency ::cs.currencies/item)
(s/def ::default-currencies (s/coll-of ::cs.currencies/item))

(s/def ::category ::cs.categories/item)
